...
def train(args, model):
    ...
    for epoch in range(1, args.num_epochs+1):
        ...
        if epoch % 2 == 0:
            save_filename = "weights/model_{}.pth".format(epoch)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model', default = "fcn8")
    ...
    parser_train.add_argument('--datadir', required=False, default="/data_1/data/VOC2012/VOCdevkit/VOC2012")
